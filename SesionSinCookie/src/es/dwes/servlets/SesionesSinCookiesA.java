...
@WebServlet("/SesionesSinCookiesA")
public class SesionesSinCookiesA extends HttpServlet {
	...
	protected void procesaSolicitud(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<html><head><title>SesionesSinCookiesA</title></head>");
            out.println("<body>");
            out.println("<h1>SesionesSinCookiesA</h1>");
            ...
            out.println("<a href=\"" + response.encodeURL(cadenaURI) + "\">Reenvío de sesión mediante URI</a>"); 
        }           
        catch (Exception e){ 
